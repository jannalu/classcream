...
class TimeClockTest < ActiveSupport::TestCase
  ...
  context "Given context" do
    ...
    should "start a shift at the current time" do
      ...
      assert_equal Time.current.hour, @shift_ralph_4.start_time.hour
      assert_equal Time.current.min, @shift_ralph_4.start_time.min 
    end
    ...
    should "end a shift at the current time" do
      ...
      assert_equal Time.current.hour, shift_cindy_2.end_time.hour
      assert_equal Time.current.min, shift_cindy_2.end_time.min
    end
