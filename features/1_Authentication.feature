Feature: Authentication
  ...
  Scenario: Admin navigation exists to link resources
    ...
    Then I should see "Active Stores owned by ClassicCreamery"
    When I go to the home page
    And I click on the link "Employees"
    # Then show me the page
    Then I should see "Active Employees at ClassicCreamery"
    When I go to the home page
  ...
  Scenario: Employee navigation limited to logout
