...
Given /^an initial setup$/ do
  ...
  @assign_ben.update_attribute(:start_date, Date.new(2025,2,14))
  @assign_ben.update_attribute(:end_date, Date.new(2025,8,17))
  @promote_ben.update_attribute(:start_date, Date.new(2025,8,17))
  @promote_ben.update_attribute(:end_date, nil)
  @assign_ed.update_attribute(:start_date, Date.new(2025,3,14))
  @assign_ralph.update_attribute(:start_date, Date.new(2025,5,21))
  @assign_cindy.update_attribute(:start_date, Date.new(2025,11,17))
  @assign_kathryn.update_attribute(:start_date, Date.new(2025,4,30))
